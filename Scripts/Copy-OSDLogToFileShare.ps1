...
Explicitly permits SMB without encryption. Integrity protection is still required.
...
function Get-SafeErrorMessage {
    ...
    if ($Exception.Message.StartsWith('Unable to verify SMB connection security: ', [StringComparison]::Ordinal)) {
        return 'Unable to verify SMB connection security.'
    }
