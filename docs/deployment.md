...
- [Run PowerShell Script step](https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/task-sequence-steps#run-powershell-script)
...
- [Last-action return code](https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/task-sequence-variables#_smstslastactionretcode)
